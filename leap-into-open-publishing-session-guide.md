...
_Pre-loads the Docsify-This Web Page Builder with Sidebar layout and custom navigation (using open publishing template `home.md` file as the default URL)._
