...
<button onclick="window.open('https://docsify-this.net/?advanced=true&sidebar=true&loadSidebar=true', '_blank')">Do it for me!</button>

_Pre-loads the Docsify-This Web Page Builder to use a custom Sidebar for multiple page sites._
