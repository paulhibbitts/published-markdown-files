...
> [!TIP]
> Already familiar with Markdown and comfortable with Web apps? Jump straight to [Challenge 1](#%F0%9F%8E%A8-challenge-1-style-lab) using the provided sample file, then come back for any needed background knowledge!
