...
<button onclick="window.open('https://docsify-this.net/?advanced=true&sidebar=true&loadSidebar=true', '_blank')">Preload Web Page Builder to use a custom Sidebar</button>
